...
- `dataset` en los CSV raw vale `OWASP | BIANCA | Jailbreak | GitHub | Custom` (malicioso) o `Benigno` (legítimo).
...
- No escribir prompts/emails/URLs inventados como si fueran CDN oficiales; si se descargan payloads usar `scripts/download_payloads.py`.
